...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'L3XSafe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <p>
      When visiting our website or using {'L3XSafe'}, we may collect and process personal data. The data will be
    ...
    <p>
      In addition, we may take a recording of you while testing {'L3XSafe'} for internal and external use. The
    ...
    <p>
      We enable the user to unlock the {'L3XSafe'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`L3XSafe`}. For
