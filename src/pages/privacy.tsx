...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;L3XSafe&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using L3XSafe</h4>
    <p>
      When visiting our website or using L3XSafe, we may collect and process personal data. The data will be stored in
      different instances
    </p>
    <ol>
      <li>
    ...
    <ol start={8}>
      <li>
        When we collect relevant&nbsp;data&nbsp;from the Blockchain to display context information in the L3XSafe we
        process:
        <ol>
          <li>your public Wallet address, </li>
          <li>account balance,</li>
    ...
    <p>
      In addition, we may take a recording of you while testing L3XSafe for internal and external use. The basis for
    ...
    <p>
      L3XSafe mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the L3XSafe mobile app via biometrics information (touch ID or face ID). This is a
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with L3XSafe. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>L3XSafe – Privacy policy</title>
      </Head>
